  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Creative Canvas Specific Colors
        canvas: {
          DEFAULT: "var(--color-canvas)", // gray-950
          foreground: "var(--color-canvas-foreground)", // gray-200
        },
        surface: {
        ...
        workspace: {
          DEFAULT: "var(--color-workspace)", // gray-900
          foreground: "var(--color-workspace-foreground)", // gray-200
          muted: "var(--color-workspace-muted)", // gray-400
        },
        // Text Hierarchy
        text: {
      ...
      fontFamily: {
        ...
        mono: ['JetBrains Mono', 'Monaco', 'Cascadia Code', 'Ubuntu Mono', 'monospace'],
      },
      fontSize: {
      ...
      boxShadow: {
        'creative': '0 4px 20px rgba(0, 0, 0, 0.15)',
        'creative-sm': '0 2px 8px rgba(0, 0, 0, 0.1)',
        'creative-lg': '0 10px 25px rgba(0, 0, 0, 0.2)',
